 ...
 *
 */
public class EdicaoAlbumRowMapper implements RowMapper<EdicaoAlbum>{
	...
	public EdicaoAlbum mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		edicaoAlbum.setPossuiEdicao(rs.getBoolean("flag_possui"));
		edicaoAlbum.setDesejaEdicao(rs.getBoolean("flag_deseja"));
