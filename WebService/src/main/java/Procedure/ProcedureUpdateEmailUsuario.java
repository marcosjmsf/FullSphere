 ...
 *
 */
public class ProcedureUpdateEmailUsuario extends StoredProcedure{

	public ProcedureUpdateEmailUsuario(DataSource dataSource) {

		super(dataSource, "UPDATE_EMAIL_USUARIO");  
