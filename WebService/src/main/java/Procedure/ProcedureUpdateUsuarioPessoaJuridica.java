 ...
 *
 */
public class ProcedureUpdateUsuarioPessoaJuridica extends StoredProcedure{
	
	
	public ProcedureUpdateUsuarioPessoaJuridica(DataSource dataSource) {
		
        super(dataSource, "UPDATE_USUARIO_JURIDICO");  
