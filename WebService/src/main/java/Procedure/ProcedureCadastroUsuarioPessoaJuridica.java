 ...
 *
 */
public class ProcedureCadastroUsuarioPessoaJuridica extends StoredProcedure{
	
	
	public ProcedureCadastroUsuarioPessoaJuridica(DataSource dataSource) {
		
        super(dataSource, "CADASTRO_USUARIO_JURIDICO");  
        ...
        declareParameter(new SqlParameter("prc_razao_social", Types.VARCHAR));
        declareParameter(new SqlParameter("prc_nm_fantasia", Types.VARCHAR));
        declareParameter(new SqlParameter("prc_cnpj", Types.VARCHAR));
        declareParameter(new SqlParameter("prc_insc_estadual", Types.VARCHAR));
        declareParameter(new SqlParameter("prc_id_plano", Types.INTEGER));
        declareParameter(new SqlParameter("prc_id_Forma_Pagamento", Types.INTEGER));
        declareParameter(new SqlParameter("prc_dt_pgto", Types.DATE));
