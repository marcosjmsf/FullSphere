 ...
 *
 */
public class ProcedureCadastroAmizade extends StoredProcedure{
	
	public ProcedureCadastroAmizade(DataSource dataSource) {
		
        super(dataSource, "CADASTRO_AMIZADE");  
        ...
        declareParameter(new SqlParameter("prc_id_estado_amizade", Types.INTEGER));
